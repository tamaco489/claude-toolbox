...
DEFAULT_TPL = {
    ...
    "styles": {
        ...
        "category_header": {"font_size": 14, "color": "#2563eb", "leading": 18, "space_before": 16, "space_after": 8},
...
def _build_content(data, tpl, styles):
    ...
    # タイトル・日付
    content.append(Paragraph(tpl.get('title', 'AIニュース要約レポート'), styles['JapaneseTitle']))
...
def main():
    ...
    out_path = os.path.join(out_dir, f'ai-news-{date}.pdf')
